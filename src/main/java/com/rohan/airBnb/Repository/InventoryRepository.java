...
import com.rohan.airBnb.dto.RoomPriceDto;
...
""")
    ...
    SET i.reservedCount = i.reservedCount + :roomsCount
     WHERE i.room.id = :roomid
        ...
        AND i.closed = false
""")
    void findAndLockReservedInventory(@Param("roomid") Long roomid,@Param("startDate") LocalDate startDate,
    ...
    @Query("""
       SELECT new com.rohan.airBnb.dto.RoomPriceDto(
            i.room,
            CASE
